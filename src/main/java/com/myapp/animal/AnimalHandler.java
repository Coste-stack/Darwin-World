...
import com.myapp.board.Board;
import com.myapp.board.BoardView;
import com.myapp.board.Tile;
...
public class AnimalHandler {
    ...
    private void moveAnimals() {
        for (Animal animal : animalList) {
            ...
            // Calculate com.myapp.animal energy consumption
            ...
            // Change com.myapp.animal position based on direction
            animal.move();
            animal.rotate();
            ...
            if (newX != currX || newY != currY) {
                // Update the com.myapp.animal's position
    ...
    private void eatFood() {
        ...
        for (Animal animal : animalList) {
            ...
            // Log the com.myapp.animal properties
            System.out.println(animalList.indexOf(animal) + " - " + animal);

            if (animal.isAlive()) {
                // Place the com.myapp.animal in the new position in the grid matrix
