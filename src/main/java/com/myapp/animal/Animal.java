...
public class Animal {
    private AnimalView animalView; // Visual representation of the com.myapp.animal
    private Point position; // Grid position of the com.myapp.animal
    private Direction direction; // Direction facing the front of the com.myapp.animal
    private int age;
